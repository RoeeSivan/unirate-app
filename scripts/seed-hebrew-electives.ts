...
const electiveHebrew: Record<string, { titleHe: string; descriptionHe: string }> = {
  ...
  'Information Theory': {
    titleHe: 'תורת האינפורמציה',
    descriptionHe: 'קורס מבוא לתורת המידע. תורת המידע עוסקת בעקרונות היסוד של ייצוג נתונים, דחיסתם ושידורם. בקורס זה נעסוק באנטרופיה, קידוד מידע, קיבולת ערוצים, תיקון שגיאות ויישומים מעשיים בתחומים כמו טלקומוניקציה, דחיסת נתונים, קריפטוגרפיה ולמידת מכונה.',
  },
  'Introduction to Bioinformatics': {
    titleHe: 'מבוא לביואינפורמטיקה',
    descriptionHe: 'קורס מבוא לביואינפורמטיקה המשלב מדעי המחשב וביולוגיה. ניתוח רצפים, הרכבת גנומים, פילוגנטיקה, חיזוי מבנה חלבונים וגישות חישוביות לבעיות ביולוגיות.',
  },
  'Advanced Topics in Computer Systems Security': {
    titleHe: 'נושאים מתקדמים באבטחת מערכות מחשוב',
    descriptionHe: 'אבטחת מערכות מחשוב זה תחום מחקר שמטרתו להבטיח אמינות ובטיחות למערכות מחשב, אפילו כשהן מצויות בסביבה עוינת. נלמד את היסודות של אבטחת מערכות מחשוב, הן מבחינה תיאורטית והן מבחינה מעשית. נבחן את הנושא משתי זוויות: ניתוח (תקיפת מערכות) ובניית מערכות מאובטחות (הגנה על מערכות).',
  },
